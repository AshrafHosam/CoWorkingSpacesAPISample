...
{
    internal static class FinancialInsightsByBrandPostgreSqlQueries
    {
        public static string OneTimeExpenseQueryByBrand = @"SELECT
...
EXTRACT(MONTH FROM ote.""TransactionExecutionDate"");";
        ...
        public static string VisitsIncomeQueryByBrand = @"SELECT
...
EXTRACT(MONTH FROM sav.""CheckOutStamp"");";
        ...
        public static string Reservations_Horly_Daily_IncomeQueryByBrand = @"SELECT
...
EXTRACT(MONTH FROM r.""EndDate"");";
        ...
        public static string RecurringExpenseQueryByBrand = @"SELECT
